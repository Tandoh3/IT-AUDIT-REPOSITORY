...
A comprehensive, end‑to‑end toolkit for performing IT Audits in any organization — from startups to large regulated institutions. This repository consolidates global best practices, regulatory requirements, templates, checklists, and documentation frameworks aligned with ISACA CISA domains and major standards.
...
* A **standardized** and **repeatable** audit approach
* A **central repository** of templates, scripts, checklists, and regulatory mappings
* **Alignment with global frameworks** (ITAF, COBIT-5, ISO, CIS) and local regulations (BoG Cybersecurity Directive, Data Protection Act, Payment Systems Act)

This repository helps auditors perform efficient, risk-focused, and compliant audits by providing everything needed in one place.

---

# 🧭 Framework & Regulatory Mapping (Based on ISACA CISA Domains)

Below is a mapping of each CISA domain with its relevant standards, clauses, and directives.
...
* **Payment Systems Act** – Requirements for PSPs, fintechs, infrastructure providers
...
1. Start with the **audit-plan template** to define scope and objectives.
2. Use the **CISA‑aligned checklists** to assess controls.
3. Use the **scripts** folder to automate evidence collection.
4. Document all findings using the **findings template**.
5. Generate final deliverables through the **report templates**.
